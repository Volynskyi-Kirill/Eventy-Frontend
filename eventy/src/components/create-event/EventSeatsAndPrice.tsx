...
export function EventSeatsAndPrice() {
  const { control, register, watch, setValue } = useFormContext<CreateEventFormData>()
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          >
            ...
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="paid">For a fee</Label>
            </div>
          </RadioGroup>
        </div>
        ...
        {fields.map((field, index) => (
          <div key={field.id} className="space-y-2">
            ...
            <Input {...register(`eventZones.${index}.name`)} placeholder="Zone name" />
            ...
            <div className="grid grid-cols-2 gap-4 mt-2">
              <div>
                ...
                <div className="flex gap-2">
                  <Input
                    type="number"
                    {...register(`eventZones.${index}.price`, { valueAsNumber: true })}
                    placeholder="Price"
                    disabled={!isPaid}
                  />
                  <Select
              ...
              <div>
                ...
                <Input
                  type="number"
                  {...register(`eventZones.${index}.seatCount`, { valueAsNumber: true })}
